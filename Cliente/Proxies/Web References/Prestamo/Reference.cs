...
namespace Proxies.Prestamo {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="PrestamoWSSoap", Namespace="http://tempuri.org/")]
    public partial class PrestamoWS : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public PrestamoWS() {
            this.Url = global::Proxies.Properties.Settings.Default.Proxies_Prestamo_PrestamoWS;
        ...
        public PrestamoBase Guardar(PrestamoBase prestamoBase) {
            object[] results = this.Invoke("Guardar", new object[] {
                        prestamoBase});
            return ((PrestamoBase)(results[0]));
        }
        
        /// <remarks/>
        public void GuardarAsync(PrestamoBase prestamoBase) {
            this.GuardarAsync(prestamoBase, null);
        }
        
        /// <remarks/>
        public void GuardarAsync(PrestamoBase prestamoBase, object userState) {
            ...
            this.InvokeAsync("Guardar", new object[] {
                        prestamoBase}, this.GuardarOperationCompleted, userState);
        }
    ...
    public partial class PrestamoBase {
    ...
    public partial class GuardarCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        /// <remarks/>
        public PrestamoBase Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((PrestamoBase)(this.results[0]));
            }
        }
    }
}
