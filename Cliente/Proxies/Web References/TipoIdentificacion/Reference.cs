...
namespace Proxies.TipoIdentificacion {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="TipoIdentificacionWSSoap", Namespace="http://tempuri.org/")]
    public partial class TipoIdentificacionWS : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public TipoIdentificacionWS() {
            this.Url = global::Proxies.Properties.Settings.Default.Proxies_TipoIdentificacion_TipoIdentificacionWS;
        ...
        public TipoIdentificacionMSJ[] Listar() {
            object[] results = this.Invoke("Listar", new object[0]);
            return ((TipoIdentificacionMSJ[])(results[0]));
        }
    ...
    public partial class TipoIdentificacionMSJ {
    ...
    public partial class ListarCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        /// <remarks/>
        public TipoIdentificacionMSJ[] Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((TipoIdentificacionMSJ[])(this.results[0]));
            }
        }
    }
}
